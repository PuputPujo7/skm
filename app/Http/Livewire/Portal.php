...
class Portal extends Component
{
    public function getData(Request $request){
        ...
        elseif ($request_id == $data_user->request_id){
            ...
            return view('livewire.pemohon-izin', compact('request_id', 'nama', 'nama_perusahaan', 'sektor', 'jenis_izin', 'alamat', 'no_telp', 'jenis_kelamin'));
        }
    }
    public function storeDataUser(Request $request)
    {
        ...
        if($nama == $data_user->nama){
            return Redirect::route('livewire.portal')->with('bad', 'Maaf, Anda Sudah Pernah Mengisi Survey Kepuasan Masyarakat, Terimakasih');
        }
        $store = new DataUser();
