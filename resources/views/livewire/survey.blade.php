                            ...
                            <footer class="mt-8">
                                <div class="md:flex md:items-center md:justify-center">
                                    ...
                                    <div class="mt-3 text-center md:mt-0 md:flex md:items-center">
                                        <div class="text-base font-medium text-gray-900">{{$lastReview->nama_perusahaan}}</div>

                                        <svg class="mx-1 hidden h-5 w-5 text-indigo-600 md:block" fill="currentColor" viewBox="0 0 20 20">
                                            <path d="M11 0h3L9 20H6l5-20z" />
                                        </svg>

                                        <div class="text-base font-medium text-gray-500">{{$lastReview->sektor}}</div>
                                    </div>
                                </div>
                            </footer>
                        </blockquote>
            ...
            <div class="overflow-hidden bg-transparent py-16 px-4 sm:px-6 lg:px-8 lg:py-12">
                <div class="relative mx-auto max-w-4xl">
                    ...
                    <div class="text-center mt-3">
                        <h2 class="text-dark mb-5 text-3xl font-bold tracking-tight sm:text-4xl">Form Survey Kepuasan Masyarakat</h2>
                    ...
                    <div class="mt-12">
                        <form wire:submit.prevent="submit" >
                                ...
                                {{-- <div class="pt-6 pb-8 grid-cols-12 md:grid md:grid-cols-12 md:gap-8"> --}}
                                        ...
                                        <div x-data="
                                            {
                                                rating: 0,
                                                hoverRating: 0,
                                                ratings: {{json_encode($pertanyaan->answer_options, true)}},
                                                rate(amount) {
                                            ...
                                            <div wire:key="star{{$loop->index+1}}" wire:model="rating.{{$loop->index}}" class="flex space-x-0 bg-transparent">
                                                <template x-for="(star, index) in ratings" :key="index" >
                                                    <div  @click="$dispatch('input', star.amount); rate(star.amount)" @mouseover="hoverRating = star.amount" @mouseleave="hoverRating = rating"
                                                            aria-hidden="true"
                                                            :title="star.label"
                                    ...
                                    @endforeach
                                        <div class="sm:col-span-12">
                                            ...
                                            <div class="mt-1 mb-3">
                                                <textarea wire:model="review" id="review" name="review" rows="4" class="border border-blue-300 block w-full rounded-md border-gray-300 py-3 px-4 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"></textarea>
                                            </div>
                                        </div>
                                </div>
                            ...
                            <div class="sm:col-span-2">
                                <button type="submit" class="inline-flex w-full items-center justify-center rounded-md border border-transparent bg-indigo-600 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">Submit</button>
                            </div>
