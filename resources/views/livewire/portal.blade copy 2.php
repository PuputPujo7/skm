<section id="hero" class="hero d-flex align-items-center pt-20">
                      ...
                      <form action="#">
                          ...
                          <div class="max-w-xl mx-auto p-1 pr-0 flex flex-wrap items-center">
                              <div class="text-center items-center justify-center flex-1 mt-4 block md:inline-block  border bg-black border-gray-400 p-3 appearance-none text-white text-base font-semibold tracking-wider uppercase py-4 rounded shadow-md">
                                  ...
                                  <div class="bg-dark text-center items-center rounded mt-2 place-items-center content-center">
                                  <img src="qr-code.png" class="bg-dark card-img-top items-center justify-center " alt="..." style="width: 96px">
                                  <img src="ptsp.png" class="bg-dark card-img-top items-center justify-center " alt="..." style="width: 96px">
                                  </div>
                              </div>
                          </div>
                      </form>
